#!/usr/bin/env npx tsx
/**
 * Test runner for golden file tests.
 *
 * Runs all golden file tests using Node.js built-in test runner.
 *
 * Usage:
 *   npx tsx .pi/tests/golden/run.ts              # Run all golden tests
 *   npx tsx .pi/tests/golden/run.ts feasibility  # Run specific test file
 */
